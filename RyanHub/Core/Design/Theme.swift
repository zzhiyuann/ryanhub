...
extension Color {
    ...
    static var hubSurface: Color {
        Color("hubSurface")
    }

    /// Secondary surface: dark #252540 / light #F0F0F2
    static var hubSurfaceSecondary: Color {
        Color("hubSurfaceSecondary")
    }

    /// Primary accent: #6366F1 (indigo, both modes)
    static let hubPrimary = Color(red: 0x63 / 255.0, green: 0x66 / 255.0, blue: 0xF1 / 255.0)

    /// Primary light variant: #818CF8
    static let hubPrimaryLight = Color(red: 0x81 / 255.0, green: 0x8C / 255.0, blue: 0xF8 / 255.0)

    /// Primary text: dark white / light #1A1A1A
    static var hubTextPrimary: Color {
        Color("hubTextPrimary")
    }

    /// Secondary text: dark #9CA3AF / light #6B7280
    static var hubTextSecondary: Color {
        Color("hubTextSecondary")
    }

    /// Accent green: #22C55E
    static let hubAccentGreen = Color(red: 0x22 / 255.0, green: 0xC5 / 255.0, blue: 0x5E / 255.0)

    /// Accent red: #EF4444
    static let hubAccentRed = Color(red: 0xEF / 255.0, green: 0x44 / 255.0, blue: 0x44 / 255.0)

    /// Accent yellow: #F59E0B
    static let hubAccentYellow = Color(red: 0xF5 / 255.0, green: 0x9E / 255.0, blue: 0x0B / 255.0)

    /// Border: dark white.opacity(0.08) / light black.opacity(0.06)
    static var hubBorder: Color {
        Color("hubBorder")
    }
}
...
extension Font {
    ...
    static let hubTitle: Font = .system(size: 28, weight: .bold)
    /// 20pt semibold — section headings
    static let hubHeading: Font = .system(size: 20, weight: .semibold)
    /// 16pt regular — body text
    static let hubBody: Font = .system(size: 16, weight: .regular)
    /// 13pt medium — captions, labels
    static let hubCaption: Font = .system(size: 13, weight: .medium)
}
