...
class Dispatcher:
    ...
    def _prompt_footer(require_delivery_summary: bool = False) -> str:
        ...
        return (
            ...
            "LANGUAGE: Strictly match the user's language. English question = 100% English response "
            "(zero Chinese characters). Chinese question = 100% Chinese response. Never mix.\n"
            "INTERNALS: Never mention localhost, port numbers, curl, bridge server, or any "
            "backend details. Present data naturally as if you inherently know it.\n"
