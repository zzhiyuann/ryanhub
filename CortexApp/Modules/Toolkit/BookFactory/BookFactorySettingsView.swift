                    ...
                    Button {
                        ...
                        HStack {
                            ...
                            Image(systemName: hasOpenaiKey ? "checkmark.circle.fill" : "xmark.circle")
                                .foregroundStyle(hasOpenaiKey ? Color.cortexAccentGreen : Color.cortexAccentRed)
                    ...
                    Button {
                        ...
                        HStack {
                            ...
                            Image(systemName: hasAnthropicKey ? "checkmark.circle.fill" : "xmark.circle")
                                .foregroundStyle(hasAnthropicKey ? Color.cortexAccentGreen : Color.cortexAccentRed)
                            Image(systemName: "chevron.right")
                                .font(.caption2)
                                .foregroundStyle(AdaptiveColors.textSecondary(for: colorScheme))
                        }
