...
// MARK: - PlantCareTracker View Model
...
final class PlantCareTrackerViewModel {
    ...
    func loadData() async {
        ...
        do {
            let url = URL(string: "\(bridgeBaseURL)/modules/plantCareTracker/data")!
    ...
    func addEntry(_ entry: PlantCareTrackerEntry) async {
        do {
            let url = URL(string: "\(bridgeBaseURL)/modules/plantCareTracker/data/add")!
    ...
    func deleteEntry(_ entry: PlantCareTrackerEntry) async {
        do {
            let url = URL(string: "\(bridgeBaseURL)/modules/plantCareTracker/data?id=\(entry.id)")!
            var request = URLRequest(url: url)
